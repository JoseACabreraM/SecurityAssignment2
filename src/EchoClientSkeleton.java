...
public class EchoClientSkeleton {
    ...
    public static void main(String[] args) {
        ...
        PublicKey[] pkpairClient, pkpairServer;
        Socket socket;
        ...
        try {
            ...
            while (!"-----END SIGNATURE-----".equals(line)) {
                line = in.readLine();
                pkpairServer = VerifyCert.vCert(in);
            }
        } catch (IOException e) {
        ...
        try {
            ...
            pkpairClient = VerifyCert.vCert(br);
        ...
        try {
            ...
            boolean serverCertificate = Verify.verify(pkpairClient[0], encryptedBytes, signatureBytes);
            System.out.println("Verify server certificate: " + serverCertificate);
    ...
    // Receives a string and return the hashed string after applying SHA1
    private static String computeSHA1(String toHash) throws NoSuchAlgorithmException {
